...
% We should use "joint" instead of "simultaneous" throughout. Do you disagree?
...
%% Above,  I am putting things in order of importance (with which I think you agree), but also re-shaping a bit according to my view. The big thing is that the internal model is what allows for multiple populations (right??), but it also analyzes different variant categories a little differently (allow them to jointly contribute to pi estimation, which is joint with )
